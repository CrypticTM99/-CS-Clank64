...
local VOICETABLE_CLANK = {
    ...
    [CHAR_SOUND_ON_FIRE] = "Burning.ogg",
    [CHAR_SOUND_OOOF] = "silence.ogg",
    [CHAR_SOUND_OOOF2] = {"Bolts.ogg","Doh2.ogg","Doh3.ogg"},
    [CHAR_SOUND_PUNCH_HOO] = "Punch Hoo.ogg",
    [CHAR_SOUND_PUNCH_WAH] = "Punch Wah.ogg",
    [CHAR_SOUND_PUNCH_YAH] = "Punch Yah.ogg",
    [CHAR_SOUND_SNORING1] = "Snore.ogg",
    [CHAR_SOUND_SNORING2] = "Snore2.ogg",
    [CHAR_SOUND_SNORING3] = {"Bolts.ogg", "Snore4.ogg", "Snore5.ogg"},
    ...
    [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = {"Jump1.ogg", "Jump2.ogg"},
    [CHAR_SOUND_YAH_WAH_HOO] = {"Jump1.ogg", "silence.ogg"},
    [CHAR_SOUND_OKEY_DOKEY] = "Jump2.ogg",
    [CHAR_SOUND_LETS_A_GO] = "silence.ogg",
    [CHAR_SOUND_DYING] = {"Dying.ogg","Dying2.ogg","Dying3.ogg"},
    [CHAR_SOUND_DROWNING] = "Drowning.ogg",
    [CHAR_SOUND_EEUH] = {"Climbup.ogg","Climbup2.ogg","Climbup3.ogg"},
    [CHAR_SOUND_MAMA_MIA] = {"Star Get.ogg","Mamamia3.ogg","Mamamia3.ogg"},
    [CHAR_SOUND_COUGHING1] = "Cough1.ogg",
    [CHAR_SOUND_COUGHING2] = "Cough2.ogg",
    [CHAR_SOUND_COUGHING3] = "Cough3.ogg",
    [CHAR_SOUND_DOH] = {"CompleteDisaster.ogg","Bolts.ogg","clanksound.ogg"},
    [CHAR_SOUND_HRMM] = {"Pickup.ogg","Pickup2.ogg","Pickup3.ogg"},
    [CHAR_SOUND_PANTING] = "Lowhp.ogg",
